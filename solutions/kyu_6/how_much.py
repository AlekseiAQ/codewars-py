...
`m` and `n` are positive or null integers with
m <= n or m >= n, m and n inclusive.
...
In the first answer his possible fortune is 37 so if he buys 7 boats each worth 5
it remains `37 - 7 * 5 = 2`, if he buys 9 cars worth 4 each it remains `37 - 9 * 4 = 1`.
